...
<body>
    ...
    <div class="admin-main">
        ...
        <header class="admin-topbar">
            ...
            <div class="topbar-title">Guest Inquiries</div>
            <div class="topbar-right">
                <span class="topbar-date"><?php echo date('l, M j'); ?></span>
                <div class="header-user-menu" id="userMenu">
                    <button class="header-user-trigger" id="userMenuTrigger">
                        <div class="header-user-avatar"><?php echo strtoupper(substr($_SESSION['admin_username'] ?? 'A', 0, 1)); ?></div>
                        <span class="header-user-name"><?php echo htmlspecialchars(strtoupper($_SESSION['admin_username'] ?? 'Admin')); ?></span>
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
                    </button>
                    <div class="header-user-dropdown" id="userDropdown">
                        <a href="admin_logout.php" class="danger">Logout</a>
                    </div>
                </div>
            </div>
        </header>
                    ...
                    <div class="inquiry-card <?php echo $cardClass; ?>">
                        ...
                        <div class="inquiry-actions">
                            <form method="POST" style="display:inline;">
                                ...
                                <?php endif; ?>
                                <button type="submit" name="action" value="delete" class="btn-action btn-delete" onclick="return confirm('Are you sure you want to delete this message?');">Delete</button>
                            </form>

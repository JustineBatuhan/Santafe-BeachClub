    ...
    <header class="main-header" style="background: rgba(15, 23, 42, 0.95);">
        ...
        <nav class="nav-menu">
            <ul>
                ...
                <li><a href="rooms.php" style="color: #fff;">Rooms</a></li>
                <li><a href="gallery.php" style="color: #fff;">Gallery</a></li>
                <li class="active"><a href="contact.php" style="color: #fff;">Contact</a></li>
            </ul>
        </nav>
            ...
            <?php else: ?>
                ...
                <form method="POST" action="contact.php">
                    <div class="form-group">
                        ...
                        <input type="text" id="guest_name" name="guest_name" class="form-control" required placeholder="John Doe" value="<?php echo htmlspecialchars($_POST['guest_name'] ?? ''); ?>">
                    </div>
                    <div class="form-group">
                        <label for="guest_email">Email Address</label>
                        <input type="email" id="guest_email" name="guest_email" class="form-control" required placeholder="john@example.com" value="<?php echo htmlspecialchars($_POST['guest_email'] ?? ''); ?>">
                    </div>
                    <div class="form-group">
                        <label for="subject">Subject</label>
                        <input type="text" id="subject" name="subject" class="form-control" required placeholder="e.g. Booking Inquiry" value="<?php echo htmlspecialchars($_POST['subject'] ?? ''); ?>">
                    </div>
                    <div class="form-group">
                        <label for="message">Message</label>
                        <textarea id="message" name="message" class="form-control" required placeholder="How can we help you?"><?php echo htmlspecialchars($_POST['message'] ?? ''); ?></textarea>
                    </div>

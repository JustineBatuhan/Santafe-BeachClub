...
<head>
    ...
    <title>Notifications - Santa Fe Beach Club</title>
...
<body>
    ...
    <main class="main-content">
        ...
        $page_subtitle = 'Front desk alerts & updates';
        $header_extra_html = '
        ...
        <div class="card">
            <div class="card-header">
                <h2>Notifications <?php echo $unread_count > 0 ? "({$unread_count} unread)" : ''; ?></h2>
            </div>
                        ...
                        <div class="notif-item type-<?php echo $type; ?> <?php echo ($is_read ? '' : 'unread'); ?>">
                            ...
                            <div class="notif-actions">
                                <?php if (!empty($n['booking_id']) && !$is_read): ?>
                                    <form method="POST" action="notifications.php" style="margin:0;" onsubmit="return false;" data-confirm-form>

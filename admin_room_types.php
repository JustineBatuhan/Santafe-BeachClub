...
$rt_data = [];
$q = $conn->query("SELECT name, image_url, gallery_images FROM room_types");
if ($q) {
...
<head>
    ...
    <title>Room Photos — Santa Fe Beach Club</title>
...
<body>
<?php $active_page = 'room_photos'; include '_sidebar.php'; ?>

<main class="main-content">
    <?php
    $page_title    = 'Room Photos';
    $page_subtitle = 'Upload and manage the primary and gallery photos shown on the rooms page for each accommodation type.';
    ...
    <div class="rp-card">
        ...
        <div class="rp-primary-wrap">
            ...
            <div class="rp-primary-actions">
                <form method="POST" onsubmit="return confirm('Reset to default photo?')">
            ...
            <div class="rp-gallery-thumbs">
                ...
                <?php else: ?>
                    ...
                    <div class="rp-thumb-wrap">
                        ...
                        <form method="POST" onsubmit="return confirm('Remove this photo?')" style="margin:0">

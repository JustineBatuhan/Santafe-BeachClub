...
<body class="home-page">
    ...
    <section class="hero-section">
        ...
        <div class="hero-content">
            ...
            <h1 class="hero-title">Escape to<br>Paradise</h1>
            <p class="hero-subtitle">Book your perfect beach getaway with comfort, luxury, and unforgettable ocean views.</p>
            ...
            <div class="hero-buttons">
                <a href="rooms.php" class="btn-hero-primary">Book Now</a>
                <a href="rooms.php" class="btn-hero-secondary">Explore Rooms</a>
            </div>
        </div>
        ...
        <div class="amenities-inner">
            <div class="amenity-item">
                ...
                <div class="amenity-text">
                    <strong>Beachfront Location</strong>
            ...
            <div class="amenity-item">
                <div class="amenity-icon-wrap">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 7s4-4 11-4 11 4 11 4M1 12s4-3 11-3 11 3 11 3M1 17s4-2 11-2 11 2 11 2"></path></svg>
                </div>
                <div class="amenity-text">
                    <strong>Ocean View Rooms</strong>
                    <span>Wake up to the sea</span>
                </div>
            </div>
            <div class="amenity-divider" aria-hidden="true"></div>
            <div class="amenity-item">
                ...
                <div class="amenity-text">
                    <strong>On-Site Dining</strong>
                    <span>Fresh coastal cuisine</span>
                </div>
            </div>
            <div class="amenity-divider" aria-hidden="true"></div>
            <div class="amenity-item">
                <div class="amenity-icon-wrap">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 20V10M12 20V4M6 20v-6"></path></svg>
                </div>
                <div class="amenity-text">
    ...
    <section class="stays-section" id="gallery">
        <div class="stays-inner">
                ...
                <div class="stay-card">
                    ...
                    <div class="stay-card-body">
                        ...
                        <div class="stay-card-footer">
                            ...
                            <a href="rooms.php" class="btn-stay-book">Book Now</a>
                        </div>
                    </div>
                </div>
                <div class="stay-card">
            ...
            <div class="stays-cta-row">
                <a href="rooms.php" class="btn-see-all-rooms">View All Room Details &rarr;</a>
            </div>
        </div>
    </section>
    ...
    <button type="button" class="chatbot-toggle" id="chatbotToggle">Chat</button>

...
<head>
    ...
    <title>Guest Management - Santa Fe Beach Club</title>
...
<?php $active_page = 'guests'; include '_sidebar.php'; ?>
            ...
            <table class="reservations-table" id="guestTable">
                ...
                <tbody id="guestTableBody">
                    ...
                    <?php foreach ($guests as $row):
                        ...
                        $book_again_url = 'book.php?' . http_build_query([
                            'rebook' => 1,
                            'step' => 2,
    ...
    <div class="modal-box">
        <div class="modal-header">
            ...
            <div class="modal-header-actions">
                <a id="modalBookAgainBtn" class="btn-book-again" href="book.php?step=2">Book Again</a>
...
function openGuestProfile(data) {
    ...
    document.getElementById('modalBookAgainBtn').href         = data.book_again_url || 'book.php?step=2';
